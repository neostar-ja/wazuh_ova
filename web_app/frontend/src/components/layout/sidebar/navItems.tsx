...
export const NAV_GROUPS: NavGroupData[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'attack-map',
        label: 'แผนที่การโจมตี',
        descriptionTh: 'แผนที่โลกแบบ real-time แสดงแหล่งที่มาของการโจมตีและเป้าหมาย',
        path: '/attack-map',
        section: 'ปฏิบัติการรักษาความปลอดภัย',
        color: '#F43F5E',
      ...
      {
        id: 'incident-reports',
        label: 'รายงาน Incident',
        descriptionTh: 'สรุปการกระทำที่ดำเนินการกับเคสระดับ High/Critical',
