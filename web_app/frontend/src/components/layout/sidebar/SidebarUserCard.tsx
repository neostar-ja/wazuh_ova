    ...
    <Box sx={{
      ...
      {collapsed ? (
        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 1 }}>
          <Tooltip title={`${user?.name || user?.username} · ${roleLabel}`} placement="right">
            <Avatar sx={{
              ...
              boxShadow: `0 0 0 2px ${roleColor}44`,
              cursor: 'default',
            }}>
              {initials}
            </Avatar>
        ...
        <Box sx={{
          ...
          background: isDark ? 'rgba(123,91,164,0.07)' : 'rgba(123,91,164,0.05)',
          border: '1px solid',
          borderColor: isDark ? 'rgba(123,91,164,0.14)' : 'rgba(123,91,164,0.1)',
        }}>
          ...
          <Box sx={{ position: 'relative', flexShrink: 0 }}>
            ...
            <Box sx={{
              ...
              bgcolor: '#22C55E',
              border: isDark ? '2px solid #110D1E' : '2px solid #F5F3FF',
